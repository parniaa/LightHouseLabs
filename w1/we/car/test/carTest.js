...
describe("#shouldBuyCar()", function() { // 3
  ...
  it("should return false the car is a hatchback and pink", function() { // 4
    const car = {
      type: "hatchback",
      color: "pink"
    };
  ...
  it("should return true when the car has 5 litres/100km and is under or equal to $5,000", function() { // 4
    const car = {
      litresPer100km: 5,
      price: 4000
    };
  ...
  it("should return true when the car has 12 litres/100km and is under or equal to $5,000", function() { // 4
    const car = {
      litresPer100km: 12,
      price: 4000
    };
  ...
  it("should return undefined if no car get passed", function() { // 4
    const car = undefined;
    const shouldBuy = shouldBuyCar(car);
